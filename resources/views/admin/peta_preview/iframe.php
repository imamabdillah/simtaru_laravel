...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?= base_url() ?>_assets_front/css/custom2.css"> -->
        ...
        <div id="page-header">
            <div class="content-header p-0">
                ...
                <div id="peta-section">
                    <div class="interface-2">
                        <div class="d-flex zoom" style="gap: 5px;">
                            <button id="btn_map_current" type="button" class="btn btn-lg btn-dark" title="Lokasi Terkini">
                                <i class="si si-paper-plane"></i>
                            </button>
                            <button id="btn_map_zoom_in" type="button" class="btn btn-lg btn-dark" title="Perbesar peta">
                                <i class="si si-magnifier-add"></i>
                            </button>
                            <button id="btn_map_zoom_out" type="button" class="btn btn-lg btn-dark" title="Perkecil peta">
                ...
                <div class="content-header-section d-flex flex-column pl-4">
                    ...
                    <!-- <button id="btn_map_zoom_in" type="button" class="btn btn-lg btn-dark mr-10" title="Perbesar peta">
                        <i class="si si-magnifier-add"></i>
                    </button>
                    <button id="btn_map_zoom_out" type="button" class="btn btn-lg btn-dark mr-10" title="Perkecil peta">
                        <i class="si si-magnifier-remove"></i>
                    </button> -->
                    <!-- <button id="btn_map_search" type="button" class="btn btn-lg btn-dark mr-10" title="Pencarian">
                        <i class="si si-magnifier" style="pointer-events: none;"></i>
                    </button> -->
                    <button id="btn_map_info" type="button" class="btn btn-lg btn-dark mr-10" title="Tampilkan Informasi Layer">
                        <i class="si si-info" style="pointer-events: none;"></i>
                    </button>
                    <button id="btn_map_layers" type="button" class="btn btn-lg btn-dark mr-10" title="Tampilkan layer peta">
                        <i class="si si-layers" style="pointer-events: none;"></i>
                    </button>
                    <button id="btn_map_base" type="button" class="btn btn-lg btn-dark mr-10" title="Pilih peta dasar">
        ...
        <div id="mobile_tabs" class="block" style="display:none">
            ...
            <div class="block-content tab-content overflow-hidden" style="font-family: 'Poppins', sans-serif;">
                ...
                <div class="tab-pane fade" id="mobile_latlng" role="tabpanel">
                    <div>
                        <label for="m_cari_lat" class="bg-dark">Latitude</label>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-12 mb-sm-2 input-group">
                <div class="input-group-prepend">
                    <div class="input-group-text" style="font-family: 'Poppins', sans-serif;">
                        Latitude:
                    </div>
                </div>
            ...
            <div class="col-lg-1 col-sm-12 pl-0">
                <button id="cari_latlng" class="btn btn-lg btn-map rounded" style; color:#ffffff;"><i class="si si-magnifier"></i> Cari</button>
            </div>
        </div>
