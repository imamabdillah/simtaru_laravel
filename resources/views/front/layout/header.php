...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url() ?>assets_front/images/favicon.ico"/>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/themes/charity.css" />
...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="classic"
    ...
    <div id="wrap">
    <div class="titlebar titlebar-md scheme-light text-center bg-center o-hidden" style="background-image: <?= isset($bg_image) && !is_null($bg_image) && $bg_image != '' ? 'url('.base_url().'assets/img/uploads/berita/'.$bg_image.')' : 'url('.base_url().'assets/img/custom/sar-gede.jpg)'?>;">
                        ...
                        <div class="row mainbar-row align-items-lg-stretch">
                                ...
                                <div class="navbar-header">
                                    <a class="navbar-brand py-3" href="index-charity.html" rel="home">
                                        <span class="navbar-brand-inner">
                                            <img class="logo-sticky logo-sticky-cust" src="<?= base_url() ?>assets_front/images/logo-tegal.png"
                                                alt="tegal">
                                            <img class="mobile-logo-default logo-sticky-cust"
                                                src="<?= base_url() ?>assets_front/images/logo-tegal.png"
                                                alt="tegal">
                                            <img class="logo-default logo-sticky-cust" src="<?= base_url() ?>assets_front/images/logo-tegal.png"
                                                alt="tegal">
                                        </span>
                                    </a>
                            ...
                            <div class="col-8">
                                <div class="collapse navbar-collapse" id="main-header-collapse">
                                    <ul id="primary-nav"
                                        class="main-nav nav align-items-lg-stretch justify-content-lg-end main-nav-hover-fade-inactive d-md-flex d-block"
                                ...
                                <div class="header-module">
                                    <a href="<?= base_url() ?>login"
                                        class="btn btn-md circle btn-bordered border-thick font-size-13 ltr-sp-025 font-weight-bold px-2 lh-115 px-2">
                                        <span>
            ...
            <div class="container titlebar-container">
                <div class="row titlebar-container">
                    <div class="titlebar-col col-md-8 col-md-offset-2">
                        <h1 data-fittext="true" data-fittext-options='{ "maxFontSize": 50, "minFontSize": 32 }'><?= $title ?></h1>
