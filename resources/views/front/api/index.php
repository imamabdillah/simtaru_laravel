            ...
            <div class="block-content" style="padding: 50px">
                ...
                <div class="form-group row" style="background: #eeeeee; padding: 5px;">
                    <div class="col-lg-12" style="word-wrap: break-word;">
                        <i class="fa fa-link"></i> <a href="<?=base_url()?>api/geojson/<?=$token?>/<?=$v['id_layer']?>/d/<?=strtolower(str_replace(' ','_',$v['nama_layer']))?>" target="_blank"><?=base_url()?>api/geojson/<?=$token?>/<?=$v['id_layer']?>/d/<?=strtolower(str_replace(' ','_',$v['nama_layer']))?></a>
                    </div>
                </div>
                <?php endforeach?>
