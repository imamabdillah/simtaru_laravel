...
<body>
                                    ...
                                    <div class="block-content">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="login-username" name="username" value="heru" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="login-password">Password</label>
                                                <input type="password" class="form-control" id="login-password" name="password" value="12345678" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="block">
                                            ...
                                            <div class="block-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="longitude" name="kegiatan" value="<?= @$kegiatan ?>" placeholder="Masukkan kegiatan" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="kegiatan_yang_diajukan">Kegiatan yang diajukan<span class="text-danger"> *)</span></label>
                                                            <input type="text" name="kegiatan_yang_diajukan" id="kegiatan_yang_diajukan" class="form-control" placeholder="Masukkan kegiatan yang diajukan" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <div class="col-sm-8">
                                                                                    <div class="input-group mb-3">
                                                                                        ...
                                                                                        <div class="custom-file">
                                                                                            <input type="file" name="<?= $row->id ?>" class="custom-file-input" id="inputGroupFile<?= $row->id ?>" accept="<?= $row->eks ?>">
    ...
    <script>
        ...
        function toggleUploadSection(index) {
            var uploadSection = document.getElementById('upload_option_' + index);
        ...
        $(() => {
            ...
            function submit_foto() {
                ...
                data.append('foto', JSON.stringify(foto.map(({
                    id,
                    ref_foto_id,
                    index
                }) => ({
