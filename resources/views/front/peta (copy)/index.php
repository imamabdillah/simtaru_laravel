...
<head>
    ...
    <title>Informasi Tata Ruang Infrastruktur dan Perencanaan Kota Surakarta | INTIP Kota Surakarta</title>
        ...
        <div id="page-header">
            <div class="content-header">
                <div id="logo" class="content-header-section">
                    <div class="row">
                        ...
                        <div class="col-11" style="padding-left: 30px;padding-top: 7px">
                            <h2 style="color: #ffffff">INTIP KOTA SURAKARTA</h2>
                ...
                <div class="content-header-section">
                    <a href="<?= base_url() ?>" id="btn_map_home" class="btn btn-lg btn-circle btn_map ml-10" title="Kembali ke beranda">
                        <i class="si si-home"></i>
                    </a>
                    <button id="btn_map_zoom_in" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Perbesar peta">
                        <i class="si si-magnifier-add"></i>
                    </button>
                    <button id="btn_map_zoom_out" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Perkecil peta">
                        <i class="si si-magnifier-remove"></i>
                    </button>
                    <button id="btn_map_search" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Pencarian">
                        <i class="si si-magnifier"></i>
                    </button>
                    <button id="btn_map_info" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Tampilkan Informasi Layer">
                        <i class="si si-info"></i>
                    </button>
                    <button id="btn_map_layers" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Tampilkan layer peta">
                        <i class="si si-layers"></i>
                    </button>
                    <button id="btn_map_base" type="button" class="btn btn-lg btn-circle btn_map ml-10" title="Pilih peta dasar">
            ...
            <div class="side_option_content">
                <div class="layer_group">
                    ...
                    <div class="layer_group_content pl-10 pb-50">
                        ...
                        <!-- covid start -->
                        <div class="jp" style="font-size: large"><b>PPKM MICRO</b></div>
                        <div style="font-size: normal; margin-left:10px" data-toggle="collapse" data-target="#layer_covid" data-id="1_1" data-from-api="false" data-device="large-screen" class="collapsed" aria-expanded="false"><i class="si si-pointer"></i> COVID-19 <span id="cl_1_1" class="count_layer badge badge-pill badge-success" style="">1</span></div>
                        <div id="layer_covid" class="collapse">
                            <div style="margin-left:30px">
                                <label class="css-control css-control-warning css-checkbox">
                                    <input id="load_layer_covid" type="radio" class="css-control-input" data-name="Persebaran Covid-19" name="layer_covid" value="Persebaran Covid-19">
                                    <span class="css-control-indicator"></span> Persebaran COVID-19 Tingkat RT </label>
                                <span class="layer_covid_loading" style="display: none;">
                                    <svg width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 -25 100 100" preserveAspectRatio="xMidYMid" class="lds-facebook">
                                        <rect ng-attr-x="{{config.x1}}" ng-attr-y="{{config.y}}" ng-attr-width="{{config.width}}" ng-attr-height="{{config.height}}" ng-attr-fill="{{config.c1}}" x="17.5" y="30" width="15" height="40" fill="#e9a837">
                                            <animate attributeName="y" calcMode="spline" values="18;30;30" keyTimes="0;0.5;1" dur="1" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s" repeatCount="indefinite"></animate>
                                            <animate attributeName="height" calcMode="spline" values="64;40;40" keyTimes="0;0.5;1" dur="1" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s" repeatCount="indefinite"></animate>
                        ...
                        <!-- simonela start -->
                        <div class="jp" style="font-size: large"><b>API Simonela</b></div>

                        <div style="font-size: normal; margin-left:10px" data-toggle="collapse" data-target="#layer_simonela" data-id="1_1" data-from-api="false" data-device="large-screen" class="collapsed" aria-expanded="false"><i class="si si-pointer"></i> Data <span id="cl_1_1" class="count_layer badge badge-pill badge-success" style="">4</span></div>
                        <div id="layer_simonela" class="collapse">

                            <?php
                            $tanggal_get = [2018, 2019, 2020, 2021];
                            for ($i = 0; $i < count($tanggal_get); $i++) :
                            ?>
                                <div style="margin-left:30px">
                                    <label class="css-control css-control-warning css-checkbox">
                                        <input type="radio" class="css-control-input load_layer_simonela simonela_<?= $tanggal_get[$i] ?>" data-name="data simonela tahun <?= $tanggal_get[$i] ?>" value="<?= $tanggal_get[$i] ?>">
                                        <span class="css-control-indicator"></span> <?= $tanggal_get[$i] ?> </label>
                                    <span class="layer_simonela_loading_<?= $tanggal_get[$i] ?>" style="display: none;">
                                        <svg width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 -25 100 100" preserveAspectRatio="xMidYMid" class="lds-facebook">
                                            <rect ng-attr-x="{{config.x1}}" ng-attr-y="{{config.y}}" ng-attr-width="{{config.width}}" ng-attr-height="{{config.height}}" ng-attr-fill="{{config.c1}}" x="17.5" y="30" width="15" height="40" fill="#e9a837">
                                                <animate attributeName="y" calcMode="spline" values="18;30;30" keyTimes="0;0.5;1" dur="1" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s" repeatCount="indefinite"></animate>
                                                <animate attributeName="height" calcMode="spline" values="64;40;40" keyTimes="0;0.5;1" dur="1" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s" repeatCount="indefinite"></animate>
            ...
            <div class="block-content tab-content overflow-hidden">
                ...
                <div class="tab-pane fade" id="mobile_latlng" role="tabpanel">
                    ...
                    <div class="mt-20 mb-20">
                        <button id="m_cari_latlng" class="btn btn-map col-12" style="background:#e9a837;color:#ffffff"><i class="si si-magnifier"></i> Cari</button>
                    </div>
                </div>
    ...
    <div id="myfooter">
        <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
                <button id="cari_latlng" class="btn btn-map" style="background:#e9a837;color:#ffffff"><i class="si si-magnifier"></i> Cari</button>
            </div>
        </div>
