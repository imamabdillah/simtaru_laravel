...
<div class="content-side content-side-full">
    <ul class="nav-main">
        ...
        <li>
            <a href="<?= base_url(); ?>admin/peta_preview"><i class="si si-pointer"></i><span class="sidebar-mini-hide">Peta</span></a>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="<?= base_url(); ?>admin/referensi/opd">Bidang</a>
                </li>
                <li>
        ...
        <li>
            <a href="<?= base_url(); ?>admin/api"><i class="si si-link"></i><span class="sidebar-mini-hide">Manajemen API</span></a>
        </li>

        <!-- <li>
                                    <a href="<?= base_url(); ?>admin/widget"><i class="fa fa-cubes"></i><span class="sidebar-mini-hide">Manajemen Widget</span></a>
                                </li> -->

        <!-- <li>
            <a href="<?= base_url(); ?>admin/panduan"><i class="si si-notebook"></i><span class="sidebar-mini-hide">Panduan</span></a>
        </li> -->
        ...
        <!-- <li>
                                    <a href="<?= base_url(); ?>admin/website/berita"><i class="si si-feed"></i><span class="sidebar-mini-hide">Berita</span></a>
                                </li> -->
        <!-- <li>
                                    <a href="<?= base_url(); ?>admin/website/layanan"><i class="si si-paper-plane"></i><span class="sidebar-mini-hide">Layanan</span></a>
                                </li> -->
        <li>
            <a href="<?= base_url(); ?>admin/website/regulasi"><i class="si si-grid"></i><span class="sidebar-mini-hide">Regulasi</span></a>
        </li>
        <!-- <li>
                                    <a href="<?= base_url(); ?>admin/website/album"><i class="si si-picture"></i><span class="sidebar-mini-hide">Album Peta</span></a>
                                </li> -->
        <!-- <li>
                                    <a href="<?= base_url(); ?>admin/website/prioritas_pembangunan"><i class="si si-list"></i><span class="sidebar-mini-hide">Prioritas Pembangunan</span></a>
                                </li> -->
    </ul>
...
<div style="background-color: rgba(0, 0, 0, 0.03); display: flex; justify-content: center; padding: 16px 0; border-radius: 8px; margin-top: 16px; backdrop-filter: blur(1px);">
    <img src="<?= base_url() ?>assets_front/images/Kabupaten_Sukoharjo.png" alt="" style="width: 100px; height: auto;">
</div>
</div>
<!-- END Side Navigation -->
</div>
