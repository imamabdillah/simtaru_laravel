...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets_front/images/favicon.png') }}" />
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('assets_front/images/favicon.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets_front/images/favicon.png') }}">
...
<body>
    <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed page-header-modern main-content-boxed">
        <nav id="sidebar" class="position relative">
            ...
            <img src="{{ asset('assets_front/images/batik-pattern-1.svg') }}" alt="" class="position-absolute" style="opacity: .1; left: 0; translate: -40% 0;">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-header content-header-fullrow px-15" style="background-color: rgba(0, 0, 0, 0.2); backdrop-filter: blur(1px);">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a class="font-w700 font-size-xl" href="{{ url('/') }}">
                    ...
                    <div class="content-side content-side-full content-side-user align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center position-relative">
                            <div class="img-link">
                                <img class="img-avatar" src="{{ asset('assets/img/avatars/avatar15.jpg') }}" alt="" style="outline: 10px solid rgba(255,255,255,0.05);" />
                            </div>

                            <div class="mt-10">
                                <div class="text-dual-primary-dark font-w600" style="font-size: 16px;">{{ session('nama') }}</div>
                            </div>

                            <a class="position-absolute block text-white" style="top: 0; right: 0; background-color: rgba(255, 255, 255, 0.2); padding: 8px 12px 8px 10px; border-radius: 8px;" href="{{ url('auth/login/out') }}">
